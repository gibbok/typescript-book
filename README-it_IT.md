...
<a href="https://gibbok.github.io/typescript-book/it-it/plus-edition/?utm_source=github&utm_medium=readme">
  <img
...
L'Edizione Plus è disponibile in inglese e italiano su Amazon in tutto il mondo. [Scopri l'Edizione Plus e acquistala su Amazon](https://gibbok.github.io/typescript-book/it-it/plus-edition/).

## Sostieni il progetto

Se il libro gratuito ti ha aiutato a correggere un bug, comprendere un concetto difficile o progredire nella carriera, valuta la possibilità di sostenere il mio lavoro pagando quanto desideri, con un contributo suggerito di **$5**, oppure offrendomi un caffè.

Il tuo sostegno mi aiuta a mantenere aggiornati i contenuti e ad ampliarli con nuovi esempi, spiegazioni più chiare e ulteriori indicazioni pratiche.
...
[Francese](https://github.com/gibbok/typescript-book/blob/main/README-fr_FR.md)
...
[Giapponese](https://github.com/gibbok/typescript-book/blob/main/README-ja_JP.md)

[Coreano](https://github.com/gibbok/typescript-book/blob/main/README-ko_KR.md)

[Polacco](https://github.com/gibbok/typescript-book/blob/main/README-pl_PL.md)
...
[Russo](https://github.com/gibbok/typescript-book/blob/main/README-ru_RU.md)

[Arabo](https://github.com/gibbok/typescript-book/blob/main/README-ar.md)
[Ceco](https://github.com/gibbok/typescript-book/blob/main/README-cs_CZ.md)
...
- [The Concise TypeScript Book](#the-concise-typescript-book)
  ...
  - [Esplorazione del sistema di tipi](#esplorazione-del-sistema-di-tipi)
    ...
    - [Assegnare un tipo: Dichiarazioni di tipo e asserzioni di tipo](#assegnare-un-tipo-dichiarazioni-di-tipo-e-asserzioni-di-tipo)
      - [Dichiarazione di tipo](#dichiarazione-di-tipo)
      - [Asserzione di tipo](#asserzione-di-tipo)
      - [Dichiarazioni ambientali](#dichiarazioni-ambientali)
    - [Controllo delle proprietà e controllo delle proprietà in eccesso](#controllo-delle-proprietà-e-controllo-delle-proprietà-in-eccesso)
    - [Tipi deboli](#tipi-deboli)
    - [Controllo rigoroso dei letterali di oggetto (freschezza)](#controllo-rigoroso-dei-letterali-di-oggetto-freschezza)
    - [Inferenza di tipo](#inferenza-di-tipo)
    - [Inferenze più avanzate](#inferenze-più-avanzate)
  ...
  - [Tipi primitivi](#tipi-primitivi)
    ...
    - [Array](#array)
    - [any](#any)
  - [Annotazioni di tipo](#annotazioni-di-tipo)
  - [Proprietà facoltative](#proprietà-facoltative)
  - [Proprietà di sola lettura](#proprietà-di-sola-lettura)
  - [Firme di indice](#firme-di-indice)
  - [Estensione dei tipi](#estensione-dei-tipi)
  - [Tipi letterali](#tipi-letterali)
  ...
  - [Predicati di tipo](#predicati-di-tipo)
  - [Unioni discriminate](#unioni-discriminate)
  - [Il tipo never](#il-tipo-never)
  - [Controllo di esaustività](#controllo-di-esaustività)
  - [Tipi di oggetto](#tipi-di-oggetto)
  - [Tipo di tupla (anonimo)](#tipo-di-tupla-anonimo)
  - [Tipo di tupla denominato (etichettato)](#tipo-di-tupla-denominato-etichettato)
  - [Tupla a lunghezza fissa](#tupla-a-lunghezza-fissa)
  - [Tipo Unione](#tipo-unione)
  - [Tipi Intersezione](#tipi-intersezione)
  - [Indicizzazione dei tipi](#indicizzazione-dei-tipi)
  ...
  - [Interfaccia e tipo](#interfaccia-e-tipo)
    ...
    - [Tipi di unione e intersezione](#tipi-di-unione-e-intersezione)
  - [Primitive di tipo predefinite](#primitive-di-tipo-predefinite)
  - [Oggetti JavaScript predefiniti comuni](#oggetti-javascript-predefiniti-comuni)
  - [Sovraccarichi](#sovraccarichi)
  - [Unione ed estensione](#unione-ed-estensione)
  - [Differenze tra tipo e interfaccia](#differenze-tra-tipo-e-interfaccia)
  - [Classe](#classe)
    - [Sintassi comune della classe](#sintassi-comune-della-classe)
    - [Costruttore](#costruttore)
    - [Costruttori privati e protetti](#costruttori-privati-e-protetti)
    ...
    - [Decoratori](#decoratori)
      ...
      - [Decoratore di metodo](#decoratore-di-metodo)
      - [Decoratori getter e setter](#decoratori-getter-e-setter)
      - [Metadati del decoratore](#metadati-del-decoratore)
...
Questo libro tratta TypeScript 7.0.
...
L'opzione "strict" migliora la sicurezza dei tipi consentendo controlli più rigorosi. È abilitata per impostazione predefinita a partire da TypeScript 6.0; in caso contrario, è necessario impostarla esplicitamente su true nel file tsconfig.json. L'abilitazione di "strict" consente a TypeScript di:
