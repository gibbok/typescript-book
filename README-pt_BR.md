...
Em TypeScript, podemos usar como assinatura de índice `string`, `number` e `symbol`:
...
Observe que o JavaScript converte automaticamente um índice com `number` para um índice com `string`, portanto, `k[1]` ou `k["1"]` retornam o mesmo valor.
