...
[![Donasi](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://www.paypal.com/paypalme/simonesxpo)

## Terjemahan

Buku ini telah diterjemahkan ke dalam beberapa bahasa, termasuk:

[Bahasa Inggris](https://github.com/gibbok/typescript-book/blob/main/README.md)
...
[Bahasa Thai](https://github.com/gibbok/typescript-book/blob/main/README-th_TH.md)
...
- [The Concise TypeScript Book](#the-concise-typescript-book)
  ...
  - [Unduhan dan situs web](#unduhan-dan-situs-web)
  - [Daftar Isi](#daftar-isi)
  - [Pendahuluan](#pendahuluan)
  - [Tentang Penulis](#tentang-penulis)
  - [Pengenalan TypeScript](#pengenalan-typescript)
    - [Apa itu TypeScript?](#apa-itu-typescript)
    - [Mengapa TypeScript?](#mengapa-typescript)
    - [TypeScript dan JavaScript](#typescript-dan-javascript)
    - [Pembuatan Kode TypeScript](#pembuatan-kode-typescript)
    - [JavaScript Modern Saat Ini (Downleveling)](#javascript-modern-saat-ini-downleveling)
  - [Memulai dengan TypeScript](#memulai-dengan-typescript)
    - [Instalasi](#instalasi)
    - [Konfigurasi](#konfigurasi)
    - [Berkas Konfigurasi TypeScript](#berkas-konfigurasi-typescript)
      - [target](#target)
      - [lib](#lib)
      - [strict](#strict)
      - [module](#module)
    ...
    - [Saran Migrasi ke TypeScript](#saran-migrasi-ke-typescript)
  - [Menjelajahi Sistem Tipe](#menjelajahi-sistem-tipe)
    - [Layanan Bahasa TypeScript](#layanan-bahasa-typescript)
    - [Pengetikan Struktural](#pengetikan-struktural)
    - [Aturan Dasar Perbandingan TypeScript](#aturan-dasar-perbandingan-typescript)
    - [Tipe sebagai Himpunan](#tipe-sebagai-himpunan)
    - [Menetapkan tipe: Deklarasi Tipe dan Asersi Tipe](#menetapkan-tipe-deklarasi-tipe-dan-asersi-tipe)
      - [Deklarasi Tipe](#deklarasi-tipe)
      - [Asersi Tipe](#asersi-tipe)
      - [Deklarasi Ambient](#deklarasi-ambient)
    - [Pemeriksaan Properti dan Pemeriksaan Properti Berlebih](#pemeriksaan-properti-dan-pemeriksaan-properti-berlebih)
    - [Tipe Lemah](#tipe-lemah)
    - [Pemeriksaan Ketat Object Literal (Freshness)](#pemeriksaan-ketat-object-literal-freshness)
    - [Inferensi Tipe](#inferensi-tipe)
    - [Inferensi Lebih Lanjut](#inferensi-lebih-lanjut)
    - [Pelebaran Tipe](#pelebaran-tipe)
    - [Const](#const)
      - [Modifier Const pada Parameter Tipe](#modifier-const-pada-parameter-tipe)
      - [Asersi Const](#asersi-const)
    - [Anotasi Tipe Eksplisit](#anotasi-tipe-eksplisit)
    - [Penyempitan Tipe](#penyempitan-tipe)
      - [Kondisi](#kondisi)
      - [Melempar atau Mengembalikan](#melempar-atau-mengembalikan)
      - [Union Terdiskriminasi](#union-terdiskriminasi)
      - [Type Guard Buatan Pengguna](#type-guard-buatan-pengguna)
      - [Penyempitan switch-true](#penyempitan-switch-true)
  - [Tipe Primitif](#tipe-primitif)
    ...
    - [bigint](#bigint)
    - [Symbol](#symbol)
    - [null dan undefined](#null-dan-undefined)
    - [Array](#array)
    - [any](#any)
  - [Anotasi Tipe](#anotasi-tipe)
  - [Properti Opsional](#properti-opsional)
  - [Properti Readonly](#properti-readonly)
  - [Index Signature](#index-signature)
  - [Memperluas Tipe](#memperluas-tipe)
  - [Tipe Literal](#tipe-literal)
  - [Inferensi Literal](#inferensi-literal)
  - [strictNullChecks](#strictnullchecks)
  - [Enum](#enum)
    - [Enum numerik](#enum-numerik)
    - [Enum string](#enum-string)
    - [Enum konstan](#enum-konstan)
    - [Pemetaan balik](#pemetaan-balik)
    - [Enum ambient](#enum-ambient)
    - [Anggota terkomputasi dan konstan](#anggota-terkomputasi-dan-konstan)
  - [Penyempitan](#penyempitan)
    - [Type guard typeof](#type-guard-typeof)
    - [Penyempitan berdasarkan truthiness](#penyempitan-berdasarkan-truthiness)
    - [Penyempitan berdasarkan kesetaraan](#penyempitan-berdasarkan-kesetaraan)
    - [Penyempitan dengan Operator In](#penyempitan-dengan-operator-in)
    - [Penyempitan instanceof](#penyempitan-instanceof)
  - [Penetapan](#penetapan)
  - [Analisis Alur Kontrol](#analisis-alur-kontrol)
  - [Predikat Tipe](#predikat-tipe)
  - [Union Terdiskriminasi](#union-terdiskriminasi-1)
  - [Tipe never](#tipe-never)
  - [Pemeriksaan Kelengkapan](#pemeriksaan-kelengkapan)
  - [Tipe Objek](#tipe-objek)
  - [Tipe Tuple (Anonim)](#tipe-tuple-anonim)
  - [Tipe Tuple Bernama (Berlabel)](#tipe-tuple-bernama-berlabel)
  - [Tuple dengan Panjang Tetap](#tuple-dengan-panjang-tetap)
  - [Tipe Union](#tipe-union)
  - [Tipe Intersection](#tipe-intersection)
  - [Pengindeksan Tipe](#pengindeksan-tipe)
  - [Tipe dari Nilai](#tipe-dari-nilai)
  - [Tipe dari Nilai Kembalian Fungsi](#tipe-dari-nilai-kembalian-fungsi)
  - [Tipe dari Modul](#tipe-dari-modul)
  - [Mapped Type](#mapped-type)
  - [Modifier Mapped Type](#modifier-mapped-type)
  - [Tipe Kondisional](#tipe-kondisional)
  - [Tipe Kondisional Distributif](#tipe-kondisional-distributif)
  - [Inferensi Tipe infer dalam Tipe Kondisional](#inferensi-tipe-infer-dalam-tipe-kondisional)
  - [Tipe Kondisional yang Telah Didefinisikan](#tipe-kondisional-yang-telah-didefinisikan)
  - [Tipe Union Template](#tipe-union-template)
  - [Tipe Any](#tipe-any)
  - [Tipe Unknown](#tipe-unknown)
  - [Tipe Void](#tipe-void)
  - [Tipe Never](#tipe-never-1)
  - [Interface dan Type](#interface-dan-type)
    - [Sintaks Umum](#sintaks-umum)
    - [Tipe Dasar](#tipe-dasar)
    - [Objek dan Interface](#objek-dan-interface)
    - [Tipe Union dan Intersection](#tipe-union-dan-intersection)
  - [Tipe Primitif Bawaan](#tipe-primitif-bawaan)
  - [Objek JS Bawaan yang Umum](#objek-js-bawaan-yang-umum)
  - [Overload](#overload)
  - [Penggabungan dan Ekstensi](#penggabungan-dan-ekstensi)
  - [Perbedaan antara Type dan Interface](#perbedaan-antara-type-dan-interface)
  - [Class](#class)
    - [Sintaks Umum Class](#sintaks-umum-class)
    - [Constructor](#constructor)
    - [Constructor Private dan Protected](#constructor-private-dan-protected)
    - [Modifier Akses](#modifier-akses)
    - [Get dan Set](#get-dan-set)
    - [Auto-Accessor dalam Class](#auto-accessor-dalam-class)
    - [this](#this)
    - [Properti Parameter](#properti-parameter)
    - [Class Abstrak](#class-abstrak)
    - [Dengan Generic](#dengan-generic)
    - [Decorator](#decorator)
      - [Decorator Class](#decorator-class)
      - [Decorator Properti](#decorator-properti)
      - [Decorator Metode](#decorator-metode)
      - [Decorator Getter dan Setter](#decorator-getter-dan-setter)
      - [Metadata Decorator](#metadata-decorator)
    - [Pewarisan](#pewarisan)
    - [Anggota Statis](#anggota-statis)
    - [Inisialisasi properti](#inisialisasi-properti)
    - [Overload metode](#overload-metode)
  - [Generic](#generic)
    - [Tipe Generic](#tipe-generic)
    - [Class Generic](#class-generic)
    - [Batasan Generic](#batasan-generic)
    - [Penyempitan kontekstual generic](#penyempitan-kontekstual-generic)
  - [Tipe Struktural yang Dihapus](#tipe-struktural-yang-dihapus)
  - [Namespace](#namespace)
  - [Symbol](#symbol-1)
  - [Direktif Triple-Slash](#direktif-triple-slash)
  - [Manipulasi Tipe](#manipulasi-tipe)
    - [Membuat Tipe dari Tipe](#membuat-tipe-dari-tipe)
    - [Tipe Akses Terindeks](#tipe-akses-terindeks)
    - [Tipe Utilitas](#tipe-utilitas)
      - [Awaited\<T\>](#awaitedt)
      - [Partial\<T\>](#partialt)
      ...
      - [NoInfer\<T\>](#noinfert)
  - [Lain-lain](#lain-lain)
    - [Error dan Penanganan Exception](#error-dan-penanganan-exception)
    - [Class Mixin](#class-mixin)
    - [Fitur Bahasa Asinkron](#fitur-bahasa-asinkron)
    - [Iterator dan Generator](#iterator-dan-generator)
    - [Referensi TsDocs JSDoc](#referensi-tsdocs-jsdoc)
    - [@types](#types)
    - [JSX](#jsx-1)
    - [Modul ES6](#modul-es6)
    - [Operator Eksponensiasi ES7](#operator-eksponensiasi-es7)
    - [Pernyataan for-await-of](#pernyataan-for-await-of)
    - [Meta-properti new target](#meta-properti-new-target)
    - [Ekspresi Import Dinamis](#ekspresi-import-dinamis)
    - ["tsc –watch"](#tsc-watch)
    - [Operator Asersi Non-null](#operator-asersi-non-null)
    - [Deklarasi dengan nilai default](#deklarasi-dengan-nilai-default)
    - [Optional Chaining](#optional-chaining)
    - [Operator Nullish Coalescing](#operator-nullish-coalescing)
    - [Tipe Template Literal](#tipe-template-literal)
    - [Overload fungsi](#overload-fungsi)
    - [Tipe Rekursif](#tipe-rekursif)
    - [Tipe Kondisional Rekursif](#tipe-kondisional-rekursif)
    - [Dukungan Modul ECMAScript di Node](#dukungan-modul-ecmascript-di-node)
    - [Fungsi Asersi](#fungsi-asersi)
    - [Tipe Tuple Variadik](#tipe-tuple-variadik)
    - [Tipe Boxed](#tipe-boxed)
    - [Kovarians dan Kontravarians dalam TypeScript](#kovarians-dan-kontravarians-dalam-typescript)
      - [Anotasi Varians Opsional untuk Parameter Tipe](#anotasi-varians-opsional-untuk-parameter-tipe)
    - [Index Signature Pola Template String](#index-signature-pola-template-string)
    - [Operator satisfies](#operator-satisfies)
    - [Import dan Export Khusus Tipe](#import-dan-export-khusus-tipe)
    - [Deklarasi using dan Pengelolaan Sumber Daya Eksplisit](#deklarasi-using-dan-pengelolaan-sumber-daya-eksplisit)
      - [Deklarasi await using](#deklarasi-await-using)
    - [Atribut Import](#atribut-import)
    - [Pemeriksaan Sintaks Ekspresi Reguler](#pemeriksaan-sintaks-ekspresi-reguler)
    - [import defer](#import-defer)
<!-- markdownlint-enable MD004 -->

## Pendahuluan

Selamat datang di The Concise TypeScript Book! Panduan ini membekali Anda dengan pengetahuan penting dan keterampilan praktis untuk pengembangan TypeScript yang efektif. Temukan konsep dan teknik utama untuk menulis kode yang bersih dan tangguh. Baik Anda seorang pemula maupun pengembang berpengalaman, buku ini berfungsi sebagai panduan menyeluruh sekaligus referensi praktis untuk memanfaatkan kemampuan TypeScript dalam proyek Anda.
...
Daftar lengkap kontributor: [https://github.com/gibbok/typescript-book/graphs/contributors](https://github.com/gibbok/typescript-book/graphs/contributors)
...
* `never`: Merepresentasikan tipe untuk nilai yang tidak pernah terjadi. Tipe ini biasanya digunakan sebagai tipe kembalian fungsi yang melempar error atau memasuki perulangan tak terbatas.

## Objek JS Bawaan yang Umum

TypeScript adalah superset dari JavaScript; TypeScript mencakup semua objek JavaScript bawaan yang umum digunakan. Anda dapat menemukan daftar lengkap objek ini di situs dokumentasi Mozilla Developer Network (MDN):
