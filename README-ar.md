...
[التشيكية](https://github.com/gibbok/typescript-book/blob/main/README-cs_CZ.md)
...
يمكن للملفات ذات الامتداد `.tsx` أو `.jsx` أن تحتوي على امتداد لصياغة JavaScript يُسمّى JSX، والمستخدم في React لتطوير واجهات المستخدم.
