...
Plus Edition, dünya genelinde Amazon'da İngilizce ve İtalyanca olarak sunulmaktadır. [Plus Edition'ı keşfedin ve Amazon'dan satın alın](https://gibbok.github.io/typescript-book/plus-edition/?utm_source=github&utm_medium=readme).
...
Desteğiniz, içeriği güncel tutmama ve yeni örnekler, daha açık açıklamalar ve ek pratik rehberlikle genişletmeme yardımcı olur.
...
[Fransızca](https://github.com/gibbok/typescript-book/blob/main/README-fr_FR.md)

[Endonezce](https://github.com/gibbok/typescript-book/blob/main/README-id_ID.md)

[İtalyanca](https://github.com/gibbok/typescript-book/blob/main/README-it_IT.md)

[Japonca](https://github.com/gibbok/typescript-book/blob/main/README-ja_JP.md)

[Korece](https://github.com/gibbok/typescript-book/blob/main/README-ko_KR.md)

[Lehçe](https://github.com/gibbok/typescript-book/blob/main/README-pl_PL.md)

[Portekizce (Brezilya)](https://github.com/gibbok/typescript-book/blob/main/README-pt_BR.md)

[İsveççe](https://github.com/gibbok/typescript-book/blob/main/README-sv_SE.md)

[Türkçe](https://github.com/gibbok/typescript-book/blob/main/README-tr_TR.md)
...
[Çekçe](https://github.com/gibbok/typescript-book/blob/main/README-cs_CZ.md)
...
- [Özlü TypeScript Kitabı](#özlü-typescript-kitabı)
  - [Projeyi Destekleyin](#projeyi-destekleyin)
  - [Çeviriler](#çeviriler)
  - [İndirmeler ve web sitesi](#i̇ndirmeler-ve-web-sitesi)
  - [İçindekiler](#i̇çindekiler)
  - [Giriş](#giriş)
  - [Yazar Hakkında](#yazar-hakkında)
  - [TypeScript'e Giriş](#typescripte-giriş)
    - [TypeScript nedir?](#typescript-nedir)
    - [Neden TypeScript?](#neden-typescript)
    - [TypeScript ve JavaScript](#typescript-ve-javascript)
    - [TypeScript Kod Üretimi](#typescript-kod-üretimi)
    - [Günümüzde Modern JavaScript (Alt Sürüme Derleme)](#günümüzde-modern-javascript-alt-sürüme-derleme)
  - [TypeScript'e Başlarken](#typescripte-başlarken)
    - [Kurulum](#kurulum)
    - [Yapılandırma](#yapılandırma)
    - [TypeScript Yapılandırma Dosyası](#typescript-yapılandırma-dosyası)
      - [target](#target)
      - [lib](#lib)
      - [strict](#strict)
      - [module](#module)
    ...
    - [TypeScript'e Geçiş Önerileri](#typescripte-geçiş-önerileri)
  - [Tür Sistemini Keşfetme](#tür-sistemini-keşfetme)
    - [TypeScript Dil Hizmeti](#typescript-dil-hizmeti)
    - [Yapısal Türleme](#yapısal-türleme)
    - [TypeScript'in Temel Karşılaştırma Kuralları](#typescriptin-temel-karşılaştırma-kuralları)
    - [Kümeler Olarak Türler](#kümeler-olarak-türler)
    - [Tür Atama: Tür Bildirimleri ve Tür Onaylamaları](#tür-atama-tür-bildirimleri-ve-tür-onaylamaları)
      - [Tür Bildirimi](#tür-bildirimi)
      - [Tür Onaylaması](#tür-onaylaması)
      - [Ortam Bildirimleri](#ortam-bildirimleri)
    - [Özellik Denetimi ve Fazla Özellik Denetimi](#özellik-denetimi-ve-fazla-özellik-denetimi)
    - [Zayıf Türler](#zayıf-türler)
    - [Katı Nesne Değişmezi Denetimi (Tazelik)](#katı-nesne-değişmezi-denetimi-tazelik)
    - [Tür Çıkarımı](#tür-çıkarımı)
    - [Daha Gelişmiş Çıkarımlar](#daha-gelişmiş-çıkarımlar)
    - [Tür Genişletme](#tür-genişletme)
    - [Const](#const)
      - [Tür Parametrelerinde Const Değiştiricisi](#tür-parametrelerinde-const-değiştiricisi)
      - [Const Onaylaması](#const-onaylaması)
    - [Açık Tür Ek Açıklaması](#açık-tür-ek-açıklaması)
    - [Tür Daraltma](#tür-daraltma)
      - [Koşullar](#koşullar)
      - [Hata fırlatma veya dönüş](#hata-fırlatma-veya-dönüş)
      - [Ayırt Edici Birleşim](#ayırt-edici-birleşim)
      - [Kullanıcı Tanımlı Tür Korumaları](#kullanıcı-tanımlı-tür-korumaları)
      - [switch-true daraltması](#switch-true-daraltması)
  - [İlkel Türler](#i̇lkel-türler)
    - [string](#string)
    - [boolean](#boolean)
    - [number](#number)
    - [bigint](#bigint)
    - [Symbol](#symbol)
    - [null ve undefined](#null-ve-undefined)
    - [Dizi](#dizi)
    - [any](#any)
  - [Tür Ek Açıklamaları](#tür-ek-açıklamaları)
  - [İsteğe Bağlı Özellikler](#i̇steğe-bağlı-özellikler)
  - [Salt Okunur Özellikler](#salt-okunur-özellikler)
  - [Dizin İmzaları](#dizin-i̇mzaları)
  - [Türleri Genişletme](#türleri-genişletme)
  - [Sabit Değer Türleri](#sabit-değer-türleri)
  - [Sabit Değer Çıkarımı](#sabit-değer-çıkarımı)
  - [strictNullChecks](#strictnullchecks)
  - [Enum'lar](#enumlar)
    - [Sayısal enum'lar](#sayısal-enumlar)
    - [Dize enum'ları](#dize-enumları)
    - [Sabit enum'lar](#sabit-enumlar)
    - [Ters eşleme](#ters-eşleme)
    - [Bildirimsel enum'lar](#bildirimsel-enumlar)
    - [Hesaplanmış ve sabit üyeler](#hesaplanmış-ve-sabit-üyeler)
  - [Daraltma](#daraltma)
    - [typeof tür korumaları](#typeof-tür-korumaları)
    - [Doğruluk değeriyle daraltma](#doğruluk-değeriyle-daraltma)
    - [Eşitlikle daraltma](#eşitlikle-daraltma)
    - [in Operatörüyle daraltma](#in-operatörüyle-daraltma)
    - [instanceof ile daraltma](#instanceof-ile-daraltma)
  - [Atamalar](#atamalar)
  - [Kontrol Akışı Analizi](#kontrol-akışı-analizi)
  - [Tür Yüklemleri](#tür-yüklemleri)
  - [Ayırt Edici Birleşimler](#ayırt-edici-birleşimler)
  - [never Türü](#never-türü)
  - [Kapsamlılık denetimi](#kapsamlılık-denetimi)
  - [Nesne Türleri](#nesne-türleri)
  - [Demet Türü (Anonim)](#demet-türü-anonim)
  - [Adlandırılmış Demet Türü (Etiketli)](#adlandırılmış-demet-türü-etiketli)
  - [Sabit Uzunluklu Demet](#sabit-uzunluklu-demet)
  - [Birleşim Türü](#birleşim-türü)
  - [Kesişim Türleri](#kesişim-türleri)
  - [Tür Dizinleme](#tür-dizinleme)
  - [Değerden Tür](#değerden-tür)
  - [Fonksiyon Dönüşünden Tür](#fonksiyon-dönüşünden-tür)
  - [Modülden Tür](#modülden-tür)
  - [Eşlenmiş Türler](#eşlenmiş-türler)
  - [Eşlenmiş Tür Değiştiricileri](#eşlenmiş-tür-değiştiricileri)
  - [Koşullu Türler](#koşullu-türler)
  - [Dağıtımlı Koşullu Türler](#dağıtımlı-koşullu-türler)
  - [Koşullu Türlerde infer Tür Çıkarımı](#koşullu-türlerde-infer-tür-çıkarımı)
  - [Önceden Tanımlanmış Koşullu Türler](#önceden-tanımlanmış-koşullu-türler)
  - [Şablon Birleşim Türleri](#şablon-birleşim-türleri)
  - [Any türü](#any-türü)
  - [Unknown türü](#unknown-türü)
  - [Void türü](#void-türü)
  - [Never türü](#never-türü-1)
  - [Arayüz ve Tür](#arayüz-ve-tür)
    - [Yaygın Sözdizimi](#yaygın-sözdizimi)
    - [Temel Türler](#temel-türler)
    - [Nesneler ve Arayüzler](#nesneler-ve-arayüzler)
    - [Birleşim ve Kesişim Türleri](#birleşim-ve-kesişim-türleri)
  - [Yerleşik İlkel Türler](#yerleşik-i̇lkel-türler)
  - [Yaygın Yerleşik JS Nesneleri](#yaygın-yerleşik-js-nesneleri)
  - [Aşırı Yüklemeler](#aşırı-yüklemeler)
  - [Birleştirme ve Genişletme](#birleştirme-ve-genişletme)
  - [Tür ve Arayüz Arasındaki Farklar](#tür-ve-arayüz-arasındaki-farklar)
  - [Sınıf](#sınıf)
    - [Sınıfın Yaygın Sözdizimi](#sınıfın-yaygın-sözdizimi)
    - [Oluşturucu](#oluşturucu)
    - [Özel ve Korumalı Oluşturucular](#özel-ve-korumalı-oluşturucular)
    - [Erişim Belirleyicileri](#erişim-belirleyicileri)
    - [Get ve Set](#get-ve-set)
    - [Sınıflarda Otomatik Erişimciler](#sınıflarda-otomatik-erişimciler)
    - [this](#this)
    - [Parametre Özellikleri](#parametre-özellikleri)
    - [Soyut Sınıflar](#soyut-sınıflar)
    - [Jeneriklerle](#jeneriklerle)
    - [Dekoratörler](#dekoratörler)
      - [Sınıf Dekoratörleri](#sınıf-dekoratörleri)
      - [Özellik Dekoratörü](#özellik-dekoratörü)
      - [Metot Dekoratörü](#metot-dekoratörü)
      - [Getter ve Setter Dekoratörleri](#getter-ve-setter-dekoratörleri)
      - [Dekoratör Meta Verisi](#dekoratör-meta-verisi)
    - [Kalıtım](#kalıtım)
    - [Statik Üyeler](#statik-üyeler)
    - [Özellik Başlatma](#özellik-başlatma)
    - [Metot Aşırı Yükleme](#metot-aşırı-yükleme)
  - [Jenerikler](#jenerikler)
    - [Jenerik Tür](#jenerik-tür)
    - [Jenerik Sınıflar](#jenerik-sınıflar)
    - [Jenerik Kısıtlamalar](#jenerik-kısıtlamalar)
    - [Jeneriklerde Bağlamsal Daraltma](#jeneriklerde-bağlamsal-daraltma)
  - [Silinen Yapısal Türler](#silinen-yapısal-türler)
  - [Ad Alanları](#ad-alanları)
  - [Semboller](#semboller)
  - [Üç Eğik Çizgi Yönergeleri](#üç-eğik-çizgi-yönergeleri)
  - [Tür İşleme](#tür-i̇şleme)
    - [Türlerden Tür Oluşturma](#türlerden-tür-oluşturma)
    - [İndeksli Erişim Türleri](#i̇ndeksli-erişim-türleri)
    - [Yardımcı Türler](#yardımcı-türler)
      - [Awaited\<T\>](#awaitedt)
      - [Partial\<T\>](#partialt)
  ...
  - [Diğer Konular](#diğer-konular)
    - [Hatalar ve İstisna İşleme](#hatalar-ve-i̇stisna-i̇şleme)
    - [Mixin Sınıfları](#mixin-sınıfları)
    - [Eşzamansız Dil Özellikleri](#eşzamansız-dil-özellikleri)
    - [Yineleyiciler ve Üreteçler](#yineleyiciler-ve-üreteçler)
    - [TsDocs JSDoc Referansı](#tsdocs-jsdoc-referansı)
    - [@types](#types)
    - [JSX](#jsx-1)
    - [ES6 Modülleri](#es6-modülleri)
    - [ES7 Üs Alma Operatörü](#es7-üs-alma-operatörü)
    - [for-await-of İfadesi](#for-await-of-i̇fadesi)
    - [Yeni target Meta Özelliği](#yeni-target-meta-özelliği)
    - [Dinamik İçe Aktarma İfadeleri](#dinamik-i̇çe-aktarma-i̇fadeleri)
    - ["tsc –watch"](#tsc-watch)
    - [Null Olmayan Onaylama Operatörü](#null-olmayan-onaylama-operatörü)
    - [Varsayılan Değerli Bildirimler](#varsayılan-değerli-bildirimler)
    - [İsteğe Bağlı Zincirleme](#i̇steğe-bağlı-zincirleme)
    - [Nullish Birleştirme Operatörü](#nullish-birleştirme-operatörü)
    - [Şablon Değişmez Türleri](#şablon-değişmez-türleri)
    - [İşlev Aşırı Yükleme](#i̇şlev-aşırı-yükleme)
    - [Özyinelemeli Türler](#özyinelemeli-türler)
    - [Özyinelemeli Koşullu Türler](#özyinelemeli-koşullu-türler)
    - [Node'da ECMAScript Modülü Desteği](#nodeda-ecmascript-modülü-desteği)
    - [Onaylama Fonksiyonları](#onaylama-fonksiyonları)
    - [Değişken Sayıda Öğeli Demet Türleri](#değişken-sayıda-öğeli-demet-türleri)
    - [Kutulanmış Türler](#kutulanmış-türler)
    - [TypeScript'te Kovaryans ve Kontravaryans](#typescriptte-kovaryans-ve-kontravaryans)
      - [Tür Parametreleri için İsteğe Bağlı Varyans Ek Açıklamaları](#tür-parametreleri-için-i̇steğe-bağlı-varyans-ek-açıklamaları)
    - [Şablon Dizesi Kalıbı İndeks İmzaları](#şablon-dizesi-kalıbı-i̇ndeks-i̇mzaları)
    - [satisfies Operatörü](#satisfies-operatörü)
    - [Yalnızca Tür İçe Aktarımları ve Dışa Aktarımı](#yalnızca-tür-i̇çe-aktarımları-ve-dışa-aktarımı)
    - [using Bildirimi ve Belirtik Kaynak Yönetimi](#using-bildirimi-ve-belirtik-kaynak-yönetimi)
      - [await using Bildirimi](#await-using-bildirimi)
    - [İçe Aktarma Nitelikleri](#i̇çe-aktarma-nitelikleri)
    - [Düzenli İfade Sözdizimi Denetimi](#düzenli-i̇fade-sözdizimi-denetimi)
...
Katkıda bulunanların tam listesi: [https://github.com/gibbok/typescript-book/graphs/contributors](https://github.com/gibbok/typescript-book/graphs/contributors)
...
TypeScript, JavaScript'in bir üst kümesidir; yaygın olarak kullanılan tüm yerleşik JavaScript nesnelerini içerir. Bu nesnelerin kapsamlı bir listesini Mozilla Developer Network (MDN) dokümantasyon sitesinde bulabilirsiniz:
