...
[Tiếng Pháp](https://github.com/gibbok/typescript-book/blob/main/README-fr_FR.md)

[Tiếng Indonesia](https://github.com/gibbok/typescript-book/blob/main/README-id_ID.md)

[Tiếng Ý](https://github.com/gibbok/typescript-book/blob/main/README-it_IT.md)

[Tiếng Nhật](https://github.com/gibbok/typescript-book/blob/main/README-ja_JP.md)

[Tiếng Hàn](https://github.com/gibbok/typescript-book/blob/main/README-ko_KR.md)

[Tiếng Ba Lan](https://github.com/gibbok/typescript-book/blob/main/README-pl_PL.md)

[Tiếng Bồ Đào Nha (Brazil)](https://github.com/gibbok/typescript-book/blob/main/README-pt_BR.md)

[Tiếng Thụy Điển](https://github.com/gibbok/typescript-book/blob/main/README-sv_SE.md)
...
[Tiếng Séc](https://github.com/gibbok/typescript-book/blob/main/README-cs_CZ.md)
...
- [Cuốn sách TypeScript súc tích](#cuốn-sách-typescript-súc-tích)
  - [Hỗ trợ dự án](#hỗ-trợ-dự-án)
  - [Các bản dịch](#các-bản-dịch)
  - [Tải xuống và trang web](#tải-xuống-và-trang-web)
  - [Mục lục](#mục-lục)
  - [Giới thiệu](#giới-thiệu)
  - [Về tác giả](#về-tác-giả)
  - [Giới thiệu về TypeScript](#giới-thiệu-về-typescript)
    - [TypeScript là gì?](#typescript-là-gì)
    - [Tại sao dùng TypeScript?](#tại-sao-dùng-typescript)
    - [TypeScript và JavaScript](#typescript-và-javascript)
    - [Sinh mã TypeScript](#sinh-mã-typescript)
    - [JavaScript hiện đại ngay bây giờ (Downleveling)](#javascript-hiện-đại-ngay-bây-giờ-downleveling)
  - [Bắt đầu với TypeScript](#bắt-đầu-với-typescript)
    - [Cài đặt](#cài-đặt)
    - [Cấu hình](#cấu-hình)
    - [Tệp cấu hình TypeScript](#tệp-cấu-hình-typescript)
      - [target](#target)
      - [lib](#lib)
      - [strict](#strict)
      - [module](#module)
    ...
    - [Lời khuyên khi chuyển sang TypeScript](#lời-khuyên-khi-chuyển-sang-typescript)
  - [Khám phá hệ thống kiểu](#khám-phá-hệ-thống-kiểu)
    - [Dịch vụ ngôn ngữ TypeScript](#dịch-vụ-ngôn-ngữ-typescript)
    - [Kiểu cấu trúc](#kiểu-cấu-trúc)
    - [Các quy tắc so sánh cơ bản của TypeScript](#các-quy-tắc-so-sánh-cơ-bản-của-typescript)
    - [Kiểu dưới dạng tập hợp](#kiểu-dưới-dạng-tập-hợp)
    - [Gán kiểu: Khai báo kiểu và Type Assertion](#gán-kiểu-khai-báo-kiểu-và-type-assertion)
      - [Khai báo kiểu](#khai-báo-kiểu)
      - [Type Assertion](#type-assertion)
      - [Khai báo ambient](#khai-báo-ambient)
    - [Kiểm tra thuộc tính và kiểm tra thuộc tính dư thừa](#kiểm-tra-thuộc-tính-và-kiểm-tra-thuộc-tính-dư-thừa)
    - [Kiểu yếu](#kiểu-yếu)
    - [Kiểm tra nghiêm ngặt object literal (Freshness)](#kiểm-tra-nghiêm-ngặt-object-literal-freshness)
    - [Suy luận kiểu](#suy-luận-kiểu)
    - [Suy luận nâng cao hơn](#suy-luận-nâng-cao-hơn)
    - [Type Widening](#type-widening)
    - [Const](#const)
      - [Modifier Const trên tham số kiểu](#modifier-const-trên-tham-số-kiểu)
      - [Const assertion](#const-assertion)
    - [Chú thích kiểu tường minh](#chú-thích-kiểu-tường-minh)
    - [Thu hẹp kiểu](#thu-hẹp-kiểu)
      - [Điều kiện](#điều-kiện)
      - [Throw hoặc return](#throw-hoặc-return)
      - [Discriminated Union](#discriminated-union)
      - [Type Guard do người dùng định nghĩa](#type-guard-do-người-dùng-định-nghĩa)
      - [Thu hẹp bằng switch-true](#thu-hẹp-bằng-switch-true)
  - [Các kiểu nguyên thủy](#các-kiểu-nguyên-thủy)
    - [string](#string)
    - [boolean](#boolean)
    - [number](#number)
    - [bigint](#bigint)
    ...
    - [Array](#array)
    - [any](#any)
  - [Chú thích kiểu](#chú-thích-kiểu)
  - [Thuộc tính tùy chọn](#thuộc-tính-tùy-chọn)
  - [Thuộc tính readonly](#thuộc-tính-readonly)
  - [Index Signature](#index-signature)
  - [Mở rộng kiểu](#mở-rộng-kiểu)
  - [Literal Type](#literal-type)
  - [Suy luận literal](#suy-luận-literal)
  - [strictNullChecks](#strictnullchecks)
  - [Enum](#enum)
    - [Enum số](#enum-số)
    - [Enum chuỗi](#enum-chuỗi)
    - [Const enum](#const-enum)
    - [Ánh xạ ngược](#ánh-xạ-ngược)
    - [Ambient enum](#ambient-enum)
    - [Thành viên computed và constant](#thành-viên-computed-và-constant)
  - [Narrowing](#narrowing)
    - [Type guard typeof](#type-guard-typeof)
    - [Thu hẹp theo truthiness](#thu-hẹp-theo-truthiness)
    - [Thu hẹp theo phép so sánh bằng](#thu-hẹp-theo-phép-so-sánh-bằng)
    - [Thu hẹp bằng toán tử In](#thu-hẹp-bằng-toán-tử-in)
    - [Thu hẹp bằng instanceof](#thu-hẹp-bằng-instanceof)
  - [Phép gán](#phép-gán)
  - [Phân tích luồng điều khiển](#phân-tích-luồng-điều-khiển)
  - [Type Predicate](#type-predicate)
  - [Discriminated Union](#discriminated-union-1)
  - [Kiểu never](#kiểu-never)
  - [Kiểm tra tính đầy đủ](#kiểm-tra-tính-đầy-đủ)
  - [Kiểu đối tượng](#kiểu-đối-tượng)
  - [Tuple Type (ẩn danh)](#tuple-type-ẩn-danh)
  - [Named Tuple Type (có nhãn)](#named-tuple-type-có-nhãn)
  - [Tuple có độ dài cố định](#tuple-có-độ-dài-cố-định)
  - [Union Type](#union-type)
  - [Intersection Type](#intersection-type)
  - [Type Indexing](#type-indexing)
  - [Kiểu từ giá trị](#kiểu-từ-giá-trị)
  - [Kiểu từ giá trị trả về của hàm](#kiểu-từ-giá-trị-trả-về-của-hàm)
  - [Kiểu từ module](#kiểu-từ-module)
  - [Mapped Type](#mapped-type)
  - [Modifier của Mapped Type](#modifier-của-mapped-type)
  - [Conditional Type](#conditional-type)
  - [Distributive Conditional Type](#distributive-conditional-type)
  - [Suy luận kiểu infer trong Conditional Type](#suy-luận-kiểu-infer-trong-conditional-type)
  - [Conditional Type được định nghĩa sẵn](#conditional-type-được-định-nghĩa-sẵn)
  - [Template Union Type](#template-union-type)
  - [Kiểu any](#kiểu-any)
  - [Kiểu unknown](#kiểu-unknown)
  - [Kiểu void](#kiểu-void)
  - [Kiểu dữ liệu never](#kiểu-dữ-liệu-never)
  - [Interface và Type](#interface-và-type)
    - [Cú pháp chung](#cú-pháp-chung)
    - [Kiểu cơ bản](#kiểu-cơ-bản)
    - [Đối tượng và Interface](#đối-tượng-và-interface)
    - [Union Type và Intersection Type](#union-type-và-intersection-type)
  - [Primitive Type tích hợp](#primitive-type-tích-hợp)
  - [Các đối tượng JS tích hợp phổ biến](#các-đối-tượng-js-tích-hợp-phổ-biến)
  - [Overload](#overload)
  - [Hợp nhất và mở rộng](#hợp-nhất-và-mở-rộng)
  - [Khác biệt giữa Type và Interface](#khác-biệt-giữa-type-và-interface)
  - [Class](#class)
    - [Cú pháp class thông dụng](#cú-pháp-class-thông-dụng)
    - [Constructor](#constructor)
    - [Constructor private và protected](#constructor-private-và-protected)
    - [Access Modifier](#access-modifier)
    - [Get và Set](#get-và-set)
    - [Auto-Accessor trong Class](#auto-accessor-trong-class)
    - [this](#this)
    - [Parameter Property](#parameter-property)
    - [Abstract Class](#abstract-class)
    - [Với Generic](#với-generic)
    - [Decorator](#decorator)
      - [Class Decorator](#class-decorator)
      - [Property Decorator](#property-decorator)
      - [Method Decorator](#method-decorator)
      - [Getter và Setter Decorator](#getter-và-setter-decorator)
      - [Metadata của Decorator](#metadata-của-decorator)
    - [Kế thừa](#kế-thừa)
    - [Thành viên static](#thành-viên-static)
    - [Khởi tạo thuộc tính](#khởi-tạo-thuộc-tính)
    - [Method overloading](#method-overloading)
  - [Generic](#generic)
    - [Generic Type](#generic-type)
    - [Generic Class](#generic-class)
    - [Ràng buộc Generic](#ràng-buộc-generic)
    - [Thu hẹp theo ngữ cảnh cho Generic](#thu-hẹp-theo-ngữ-cảnh-cho-generic)
  - [Kiểu cấu trúc bị xóa](#kiểu-cấu-trúc-bị-xóa)
  - [Namespace](#namespace)
  - [Symbol](#symbol-1)
  - [Triple-Slash Directive](#triple-slash-directive)
  - [Thao tác kiểu](#thao-tác-kiểu)
    - [Tạo kiểu từ kiểu](#tạo-kiểu-từ-kiểu)
    ...
    - [Utility Type](#utility-type)
      ...
      - [NoInfer\<T\>](#noinfert)
  - [Khác](#khác)
    - [Lỗi và xử lý ngoại lệ](#lỗi-và-xử-lý-ngoại-lệ)
    - [Mixin class](#mixin-class)
    - [Các tính năng ngôn ngữ bất đồng bộ](#các-tính-năng-ngôn-ngữ-bất-đồng-bộ)
    - [Iterator và Generator](#iterator-và-generator)
    - [Tham khảo TsDocs JSDoc](#tham-khảo-tsdocs-jsdoc)
    - [@types](#types)
    - [JSX](#jsx-1)
    - [ES6 Module](#es6-module)
    - [Toán tử lũy thừa ES7](#toán-tử-lũy-thừa-es7)
    - [Câu lệnh for-await-of](#câu-lệnh-for-await-of)
    - [Meta-property new target](#meta-property-new-target)
    - [Biểu thức Dynamic Import](#biểu-thức-dynamic-import)
    - ["tsc –watch"](#tsc-watch)
    - [Toán tử Non-null Assertion](#toán-tử-non-null-assertion)
    - [Khai báo có giá trị mặc định](#khai-báo-có-giá-trị-mặc-định)
    - [Optional Chaining](#optional-chaining)
    - [Toán tử Nullish Coalescing](#toán-tử-nullish-coalescing)
    - [Template Literal Type](#template-literal-type)
    - [Function overloading](#function-overloading)
    - [Kiểu đệ quy](#kiểu-đệ-quy)
    - [Recursive Conditional Type](#recursive-conditional-type)
    - [Hỗ trợ ECMAScript Module trong Node](#hỗ-trợ-ecmascript-module-trong-node)
    - [Assertion Function](#assertion-function)
    - [Variadic Tuple Type](#variadic-tuple-type)
    - [Boxed type](#boxed-type)
    - [Covariance và Contravariance trong TypeScript](#covariance-và-contravariance-trong-typescript)
      - [Variance Annotation tùy chọn cho tham số kiểu](#variance-annotation-tùy-chọn-cho-tham-số-kiểu)
    - [Template String Pattern Index Signature](#template-string-pattern-index-signature)
    - [Toán tử satisfies](#toán-tử-satisfies)
    - [Import và Export chỉ dành cho Type](#import-và-export-chỉ-dành-cho-type)
    - [Khai báo using và Explicit Resource Management](#khai-báo-using-và-explicit-resource-management)
      - [Khai báo await using](#khai-báo-await-using)
    - [Import Attribute](#import-attribute)
    - [Kiểm tra cú pháp Regular Expression](#kiểm-tra-cú-pháp-regular-expression)
