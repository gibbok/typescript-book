...
Pokud vám bezplatná kniha pomohla opravit chybu, pochopit obtížný koncept nebo postoupit v kariéře, zvažte prosím podporu mé práce příspěvkem v libovolné výši, s doporučenou částkou **$5**, nebo mi kupte kávu.

Vaše podpora mi pomáhá udržovat obsah aktuální a rozšiřovat jej o nové příklady, srozumitelnější vysvětlení a další praktické rady.

[![Kupte mi kávu](https://img.shields.io/badge/buy_me_a_coffee-FFDD00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black)](https://www.buymeacoffee.com/simonepoggiali)

[![Přispět](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://www.paypal.com/paypalme/simonesxpo)

## Překlady

Tato kniha byla přeložena do několika jazyků, mezi něž patří:

[Angličtina](https://github.com/gibbok/typescript-book/blob/main/README.md)

[Bulharština](https://github.com/gibbok/typescript-book/blob/main/README-bg_BG.md)

[Němčina](https://github.com/gibbok/typescript-book/blob/main/README-de_DE.md)

[Francouzština](https://github.com/gibbok/typescript-book/blob/main/README-fr_FR.md)

[Indonéština](https://github.com/gibbok/typescript-book/blob/main/README-id_ID.md)

[Italština](https://github.com/gibbok/typescript-book/blob/main/README-it_IT.md)

[Japonština](https://github.com/gibbok/typescript-book/blob/main/README-ja_JP.md)

[Korejština](https://github.com/gibbok/typescript-book/blob/main/README-ko_KR.md)

[Polština](https://github.com/gibbok/typescript-book/blob/main/README-pl_PL.md)

[Portugalština (Brazílie)](https://github.com/gibbok/typescript-book/blob/main/README-pt_BR.md)

[Švédština](https://github.com/gibbok/typescript-book/blob/main/README-sv_SE.md)

[Turečtina](https://github.com/gibbok/typescript-book/blob/main/README-tr_TR.md)

[Vietnamština](https://github.com/gibbok/typescript-book/blob/main/README-vi_VN.md)

[Čínština](https://github.com/gibbok/typescript-book/blob/main/README-zh_CN.md)

[Španělština](https://github.com/gibbok/typescript-book/blob/main/README_es_ES.md)

[Thajština](https://github.com/gibbok/typescript-book/blob/main/README-th_TH.md)
...
- [The Concise TypeScript Book](#the-concise-typescript-book)
  - [Podpořte projekt](#podpořte-projekt)
  - [Překlady](#překlady)
  - [Soubory ke stažení a web](#soubory-ke-stažení-a-web)
  - [Obsah](#obsah)
  - [Úvod](#úvod)
  - [O autorovi](#o-autorovi)
  - [Úvod do TypeScriptu](#úvod-do-typescriptu)
    - [Co je TypeScript?](#co-je-typescript)
    - [Proč TypeScript?](#proč-typescript)
    - [TypeScript a JavaScript](#typescript-a-javascript)
    - [Generování kódu TypeScriptem](#generování-kódu-typescriptem)
    - [Moderní JavaScript už nyní (převod na starší verze)](#moderní-javascript-už-nyní-převod-na-starší-verze)
  - [Začínáme s TypeScriptem](#začínáme-s-typescriptem)
    - [Instalace](#instalace)
    - [Konfigurace](#konfigurace)
    - [Konfigurační soubor TypeScriptu](#konfigurační-soubor-typescriptu)
      - [target](#target)
      - [lib](#lib)
      - [strict](#strict)
      - [module](#module)
    ...
    - [Rady pro migraci na TypeScript](#rady-pro-migraci-na-typescript)
  - [Zkoumání typového systému](#zkoumání-typového-systému)
    - [Jazyková služba TypeScriptu](#jazyková-služba-typescriptu)
    - [Strukturální typování](#strukturální-typování)
    - [Základní pravidla porovnávání v TypeScriptu](#základní-pravidla-porovnávání-v-typescriptu)
    - [Typy jako množiny](#typy-jako-množiny)
    - [Přiřazení typu: deklarace typů a přetypování](#přiřazení-typu-deklarace-typů-a-přetypování)
      - [Deklarace typu](#deklarace-typu)
      - [Přetypování](#přetypování)
      - [Ambientní deklarace](#ambientní-deklarace)
    - [Kontrola vlastností a kontrola nadbytečných vlastností](#kontrola-vlastností-a-kontrola-nadbytečných-vlastností)
    - [Slabé typy](#slabé-typy)
    - [Přísná kontrola objektových literálů (čerstvost)](#přísná-kontrola-objektových-literálů-čerstvost)
    - [Odvozování typů](#odvozování-typů)
    - [Pokročilejší odvozování typů](#pokročilejší-odvozování-typů)
    - [Rozšiřování typů](#rozšiřování-typů)
    - [Const](#const)
      - [Modifikátor const u typových parametrů](#modifikátor-const-u-typových-parametrů)
      - [Přetypování const](#přetypování-const)
    - [Explicitní typová anotace](#explicitní-typová-anotace)
    - [Zužování typů](#zužování-typů)
      - [Podmínky](#podmínky)
      - [Vyhození chyby nebo návrat](#vyhození-chyby-nebo-návrat)
      - [Diskriminované sjednocení](#diskriminované-sjednocení)
      - [Uživatelsky definovaní typoví strážci](#uživatelsky-definovaní-typoví-strážci)
      - [Zužování pomocí switch-true](#zužování-pomocí-switch-true)
  - [Primitivní typy](#primitivní-typy)
    - [string](#string)
    - [boolean](#boolean)
    - [number](#number)
    - [bigint](#bigint)
    - [Symbol](#symbol)
    - [null a undefined](#null-a-undefined)
    - [Pole](#pole)
    - [any](#any)
  - [Typové anotace](#typové-anotace)
  - [Volitelné vlastnosti](#volitelné-vlastnosti)
  - [Vlastnosti pouze pro čtení](#vlastnosti-pouze-pro-čtení)
  - [Indexové signatury](#indexové-signatury)
  - [Rozšíření typů](#rozšíření-typů)
  - [Literálové typy](#literálové-typy)
  - [Odvozování literálových typů](#odvozování-literálových-typů)
  - [strictNullChecks](#strictnullchecks)
  - [Výčtové typy](#výčtové-typy)
    - [Číselné výčtové typy](#číselné-výčtové-typy)
    - [Řetězcové výčtové typy](#řetězcové-výčtové-typy)
    - [Konstantní výčtové typy](#konstantní-výčtové-typy)
    - [Zpětné mapování](#zpětné-mapování)
    - [Ambientní výčtové typy](#ambientní-výčtové-typy)
    - [Vypočítávané a konstantní členy](#vypočítávané-a-konstantní-členy)
  - [Zužování typů](#zužování-typů-1)
    - [Typoví strážci typeof](#typoví-strážci-typeof)
    - [Zužování podle pravdivostní hodnoty](#zužování-podle-pravdivostní-hodnoty)
    - [Zužování podle rovnosti](#zužování-podle-rovnosti)
    - [Zužování pomocí operátoru in](#zužování-pomocí-operátoru-in)
    - [Zužování pomocí instanceof](#zužování-pomocí-instanceof)
  - [Přiřazení](#přiřazení)
  - [Analýza toku řízení](#analýza-toku-řízení)
  - [Typové predikáty](#typové-predikáty)
  - [Diskriminovaná sjednocení](#diskriminovaná-sjednocení)
  - [Datový typ never](#datový-typ-never)
  - [Kontrola úplnosti](#kontrola-úplnosti)
  - [Objektové typy](#objektové-typy)
  - [Typ n-tice (anonymní)](#typ-n-tice-anonymní)
  - [Pojmenovaný typ n-tice (s popisky)](#pojmenovaný-typ-n-tice-s-popisky)
  - [N-tice s pevnou délkou](#n-tice-s-pevnou-délkou)
  - [Sjednocený typ](#sjednocený-typ)
  - [Průnikové typy](#průnikové-typy)
  - [Indexování typů](#indexování-typů)
  - [Typ z hodnoty](#typ-z-hodnoty)
  - [Typ z návratové hodnoty funkce](#typ-z-návratové-hodnoty-funkce)
  - [Typ z modulu](#typ-z-modulu)
  - [Mapované typy](#mapované-typy)
  - [Modifikátory mapovaných typů](#modifikátory-mapovaných-typů)
  - [Podmíněné typy](#podmíněné-typy)
  - [Distributivní podmíněné typy](#distributivní-podmíněné-typy)
  - [Odvozování typů pomocí infer v podmíněných typech](#odvozování-typů-pomocí-infer-v-podmíněných-typech)
  - [Předdefinované podmíněné typy](#předdefinované-podmíněné-typy)
  - [Šablonové sjednocené typy](#šablonové-sjednocené-typy)
  - [Typ any](#typ-any)
  - [Typ unknown](#typ-unknown)
  - [Typ void](#typ-void)
  - [Typ never](#typ-never)
  - [Rozhraní a typ](#rozhraní-a-typ)
    - [Obvyklá syntaxe](#obvyklá-syntaxe)
    - [Základní typy](#základní-typy)
    - [Objekty a rozhraní](#objekty-a-rozhraní)
    - [Sjednocení a průniky typů](#sjednocení-a-průniky-typů)
  - [Vestavěné primitivní typy](#vestavěné-primitivní-typy)
  - [Běžné vestavěné objekty JS](#běžné-vestavěné-objekty-js)
  - [Přetížení](#přetížení)
  - [Slučování a rozšiřování](#slučování-a-rozšiřování)
  - [Rozdíly mezi typem a rozhraním](#rozdíly-mezi-typem-a-rozhraním)
  - [Třída](#třída)
    - [Obvyklá syntaxe třídy](#obvyklá-syntaxe-třídy)
    - [Konstruktor](#konstruktor)
    - [Soukromé a chráněné konstruktory](#soukromé-a-chráněné-konstruktory)
    - [Modifikátory přístupu](#modifikátory-přístupu)
    - [Get a Set](#get-a-set)
    - [Automatické přístupové metody ve třídách](#automatické-přístupové-metody-ve-třídách)
    - [this](#this)
    - [Vlastnosti deklarované v parametrech](#vlastnosti-deklarované-v-parametrech)
    - [Abstraktní třídy](#abstraktní-třídy)
    - [S generiky](#s-generiky)
    - [Dekorátory](#dekorátory)
      - [Dekorátory tříd](#dekorátory-tříd)
      - [Dekorátor vlastnosti](#dekorátor-vlastnosti)
      - [Dekorátor metody](#dekorátor-metody)
      - [Dekorátory getterů a setterů](#dekorátory-getterů-a-setterů)
      - [Metadata dekorátorů](#metadata-dekorátorů)
    - [Dědičnost](#dědičnost)
    - [Statické členy](#statické-členy)
    - [Inicializace vlastností](#inicializace-vlastností)
    - [Přetěžování metod](#přetěžování-metod)
  - [Generika](#generika)
    - [Generický typ](#generický-typ)
    - [Generické třídy](#generické-třídy)
    - [Omezení generik](#omezení-generik)
    - [Kontextové zužování typů u generik](#kontextové-zužování-typů-u-generik)
  - [Vymazané strukturální typy](#vymazané-strukturální-typy)
  - [Jmenné prostory](#jmenné-prostory)
  - [Symboly](#symboly)
  - [Direktivy s trojitým lomítkem](#direktivy-s-trojitým-lomítkem)
  - [Manipulace s typy](#manipulace-s-typy)
    - [Vytváření typů z typů](#vytváření-typů-z-typů)
    - [Typy s indexovaným přístupem](#typy-s-indexovaným-přístupem)
    - [Pomocné typy](#pomocné-typy)
      - [Awaited\<T\>](#awaitedt)
      - [Partial\<T\>](#partialt)
      ...
      - [NoInfer\<T\>](#noinfert)
  - [Ostatní](#ostatní)
    - [Chyby a zpracování výjimek](#chyby-a-zpracování-výjimek)
    - [Mixinové třídy](#mixinové-třídy)
    - [Asynchronní jazykové funkce](#asynchronní-jazykové-funkce)
    - [Iterátory a generátory](#iterátory-a-generátory)
    - [Referenční příručka TsDocs JSDoc](#referenční-příručka-tsdocs-jsdoc)
    - [@types](#types)
    - [JSX](#jsx-1)
    - [Moduly ES6](#moduly-es6)
    - [Operátor umocňování ES7](#operátor-umocňování-es7)
    - [Příkaz for-await-of](#příkaz-for-await-of)
    - [Metavlastnost new.target](#metavlastnost-newtarget)
    - [Výrazy dynamického importu](#výrazy-dynamického-importu)
    - ["tsc –watch"](#tsc-watch)
    - [Operátor potvrzení nenulové hodnoty](#operátor-potvrzení-nenulové-hodnoty)
    - [Deklarace s výchozími hodnotami](#deklarace-s-výchozími-hodnotami)
    - [Volitelné řetězení](#volitelné-řetězení)
    - [Operátor slučování nulových hodnot](#operátor-slučování-nulových-hodnot)
    - [Typy šablonových literálů](#typy-šablonových-literálů)
    - [Přetěžování funkcí](#přetěžování-funkcí)
    - [Rekurzivní typy](#rekurzivní-typy)
    - [Rekurzivní podmíněné typy](#rekurzivní-podmíněné-typy)
    - [Podpora modulů ECMAScript v Node](#podpora-modulů-ecmascript-v-node)
    - [Aserční funkce](#aserční-funkce)
    - [Variadické typy n-tic](#variadické-typy-n-tic)
    - [Obalové typy](#obalové-typy)
    - [Kovariance a kontravariance v TypeScriptu](#kovariance-a-kontravariance-v-typescriptu)
      - [Volitelné anotace variance pro typové parametry](#volitelné-anotace-variance-pro-typové-parametry)
    - [Indexové signatury se vzory šablonových řetězců](#indexové-signatury-se-vzory-šablonových-řetězců)
    - [Operátor satisfies](#operátor-satisfies)
    - [Importy a exporty pouze typů](#importy-a-exporty-pouze-typů)
    - [Deklarace using a explicitní správa prostředků](#deklarace-using-a-explicitní-správa-prostředků)
      - [Deklarace await using](#deklarace-await-using)
    - [Atributy importu](#atributy-importu)
    - [Kontrola syntaxe regulárních výrazů](#kontrola-syntaxe-regulárních-výrazů)
    - [import defer](#import-defer)
<!-- markdownlint-enable MD004 -->

## Úvod

Vítejte v knize The Concise TypeScript Book! Tato příručka vás vybaví základními znalostmi a praktickými dovednostmi pro efektivní vývoj v TypeScriptu. Objevte klíčové koncepty a techniky pro psaní čistého a robustního kódu. Ať už jste začátečník, nebo zkušený vývojář, tato kniha slouží jako ucelený průvodce i praktická příručka pro využití možností TypeScriptu ve vašich projektech.

Tato kniha se věnuje TypeScriptu 7.0.

## O autorovi

Simone Poggiali je zkušený Staff Engineer, který se s nadšením věnuje psaní kódu na profesionální úrovni již od 90. let. Během své mezinárodní kariéry přispěl k mnoha projektům pro širokou škálu klientů, od startupů až po velké organizace. Z jeho odborných znalostí a nasazení těžily významné společnosti jako HelloFresh, Siemens, O2, Leroy Merlin a Snowplow.

Simoneho Poggialiho můžete kontaktovat na následujících platformách:
...
Úplný seznam přispěvatelů: [https://github.com/gibbok/typescript-book/graphs/contributors](https://github.com/gibbok/typescript-book/graphs/contributors)
...
## Diskriminovaná sjednocení

Diskriminovaná sjednocení v TypeScriptu jsou druhem sjednoceného typu, který používá společnou vlastnost, označovanou jako diskriminant, k zúžení množiny možných typů ve sjednocení.
...
Typ n-tice je typ, který představuje pole s pevným počtem prvků a jejich odpovídajícími typy. Typ n-tice vynucuje konkrétní počet prvků a jejich příslušné typy v pevném pořadí. Typy n-tic jsou užitečné, když chcete reprezentovat kolekci hodnot s konkrétními typy, kde má pozice každého prvku v poli určitý význam.

```typescript
type Point = [number, number];
```

## Pojmenovaný typ n-tice (s popisky)
...
## Typ z návratové hodnoty funkce
...
## Odvozování typů pomocí infer v podmíněných typech
...
Typ `void` se používá k označení toho, že funkce nevrací hodnotu.
...
* `symbol`: Představuje jedinečný identifikátor. Symboly se obvykle používají jako klíče vlastností objektů.
* `bigint`: Představuje celá čísla s libovolnou přesností.
* `any`: Představuje dynamický nebo neznámý typ. Proměnné typu any mohou obsahovat hodnoty libovolného typu a obcházejí typovou kontrolu.
* `void`: Představuje nepřítomnost jakéhokoli typu. Běžně se používá jako návratový typ funkcí, které nevracejí hodnotu.
* `never`: Představuje typ pro hodnoty, které nikdy nenastanou. Obvykle se používá jako návratový typ funkcí, které vyhodí chybu nebo vstoupí do nekonečné smyčky.

## Běžné vestavěné objekty JS

TypeScript je nadmnožinou JavaScriptu; zahrnuje všechny běžně používané vestavěné objekty JavaScriptu. Rozsáhlý seznam těchto objektů najdete na webu s dokumentací Mozilla Developer Network (MDN):
[https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects)

Zde je seznam některých běžně používaných vestavěných objektů JavaScriptu:
...
## Rozdíly mezi typem a rozhraním
